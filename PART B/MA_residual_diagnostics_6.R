...
model_residuals <- residuals(model_ma1)
...
png("fig_04_MA_residual_diagnostics.png", width = 800, height = 600, res = 100)
par(mfrow=c(2,1), mar=c(4,4,2,1))

plot(model_residuals, type = "l", col = "darkgray", lwd = 1,
     main = "MA(1) Model Residuals", ylab = "Error", xlab = "Time")
abline(h = 0, col = "red", lty = 2)

acf(model_residuals, main = "ACF of MA(1) Residuals", lag.max = 40, col = "blue")
