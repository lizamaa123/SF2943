...
model_residuals <- residuals(model_ar1)

cat("\n--- Ljung-Box Test on AR(1) Residuals ---\n")
...
png("fig_04_AR_residual_diagnostics.png", width = 800, height = 600, res = 100)
par(mfrow=c(2,1), mar=c(4,4,2,1))

plot(model_residuals, type = "l", col = "darkgray", lwd = 1,
     main = "AR(1) Model Residuals", ylab = "Error", xlab = "Time")
abline(h = 0, col = "red", lty = 2)

acf(model_residuals, main = "ACF of AR(1) Residuals", lag.max = 40, col = "blue")
