...
def load_data(file_path='se_d_data.csv', target_col='SE3'):
...
def evaluate_forecast(y_true, y_pred):
    """Calculate and print standard time series error metrics."""
    # Ensure aligning indexes just in case
    ...
    print("\n" + "="*45)
    print(" FORECASTING ERROR METRICS (Out-of-Sample)")
    print("="*45)
...
def main():
    ...
    metrics = evaluate_forecast(y_test, res['y_hat'])
